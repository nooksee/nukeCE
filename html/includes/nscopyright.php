...
echo "<img src='images/arrow.png' alt='' title=''>&nbsp;<b>Module's Name:</b> $mod_name<br />\n";
if ($module_version != "") { echo "<img src='images/arrow.png' alt='' title=''>&nbsp;<b>Module's Version:</b> $module_version<br />\n"; }
if ($release_date != "") { echo "<img src='images/arrow.png' alt='' title=''>&nbsp;<b>Release Date:</b> $release_date<br />\n"; }
if ($mod_cost != "") { echo "<img src='images/arrow.png' alt='' title=''>&nbsp;<b>Module's Cost:</b> $mod_cost<br />\n"; }
if ($license != "") { echo "<img src='images/arrow.png' alt='' title=''>&nbsp;<b>License:</b> $license<br />\n"; }
if ($author_name != "") { echo "<img src='images/arrow.png' alt='' title=''>&nbsp;<b>Author's Name:</b> $author_name<br />\n"; }
if ($author_email != "") { echo "<img src='images/arrow.png' alt='' title=''>&nbsp;<b>Author's Email:</b> $author_email<br />\n"; }
if ($module_description != "") { echo "<img src='images/arrow.png' alt='' title=''>&nbsp;<b>Module's Description:</b> $module_description<br />\n"; }
if ($download_location != "") { echo "<img src='images/arrow.png' alt='' title=''>&nbsp;<b>Module's Download:</b> <a href=\"$download_location\" target=\"new\">Download</a><br />\n"; }
echo "<hr />\n";
