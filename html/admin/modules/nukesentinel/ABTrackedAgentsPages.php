...
if($direction == "asc") {
    echo "
          <a href='".$admin_file.".php?op=ABTrackedAgentsPages&tid=$tid&column=page&direction=desc&showmodule=$showmodule'>
              &nbsp;
              "._AB_PAGEVIEWED."
          </a>
         ";
    ...
    echo "
          <a href='".$admin_file.".php?op=ABTrackedAgentsPages&tid=$tid&column=page&direction=asc&showmodule=$showmodule'>
              &nbsp;
              "._AB_PAGEVIEWED."
          </a>
         ";
...
if($direction == "asc") {
    echo "
          <a href='".$admin_file.".php?op=ABTrackedAgentsPages&tid=$tid&column=date&direction=desc&showmodule=$showmodule'>
              "._AB_HITDATE."
          </a>
         ";
} else {
    echo "
          <a href='".$admin_file.".php?op=ABTrackedAgentsPages&tid=$tid&column=date&direction=asc&showmodule=$showmodule'>
              "._AB_HITDATE."
          </a>
         ";
}                      
