  ...
  <tr> 
    ...
    <td class="row1" rowspan="3" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
        ...
        <tr> 
          ...
          <td valign="top"><strong><span class="gen">{POSTS}</span></strong><br /><span class="genmed">[{POST_PERCENT_STATS} / {POST_DAY_STATS}]</span> <br /><span class="genmed"><a href="{U_SEARCH_USER}" class="genmed">{L_SEARCH_USER_POSTS}</a><br /><a href="{U_PERSONAL_GALLERY}" class="genmed">{L_PERSONAL_GALLERY}</a></span></td>
        </tr>
        <tr> 
            ...
            <td> 
                ...
                <tr> 
                    <td colspan="3" width="100%" class="row2">
                        ...
                        <tr> 
                            <td bgcolor="{T_TD_COLOR2}"><img src="themes/NukeGold/forums/images/spacer.gif" width="{UPLOAD_LIMIT_IMG_WIDTH}" height="8" alt="{UPLOAD_LIMIT_PERCENT}" /></td>
                        </tr>
                        </table>
                    </td>
                </tr>
                ...
                <span class="genmed">[{UPLOADED} / {QUOTA}]</span> <br />
