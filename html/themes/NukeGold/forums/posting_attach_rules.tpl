        ...
        <tr>
            <td>
                <table style="background-color: #FFFFFF; border-color: #006699; border-style: solid; border-width: 1px;" width="100%" cellpadding="4" cellspacing="1" border="0">
                    <tr>
                        <th style="background-color: #006699; background-image: url(themes/NukeGold/forums/images/cellpic3.gif); color: #FFA34F; font-size: 11px; font-weight: bold; height: 25px;" align="center">{L_RULES_TITLE}</th>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #EFEFEF; color: inherit;" width="100%" align="center">
                            <table style="background-color: #FFFFFF; border-color: #006699; border-style: solid; border-width: 1px;" width="100%" cellpadding="4" cellspacing="1" border="0">
                                <tr>
                                    <th style="background-color: #006699; background-image: url(themes/NukeGold/forums/images/cellpic3.gif); color: #FFA34F; font-size: 11px; font-weight: bold; height: 25px;" align="center">{group_row.GROUP_RULE_HEADER}</th>
                                </tr>
                                <tr>
