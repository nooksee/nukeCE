<script type="text/javascript">
    Sexy.js("modules/Forums/includes/js/addcss.js");
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
    ...
    <tr>
        <td class="row1">
            <iframe onload="addCSS ()" id="review" name="review" width="100%" height="300" src="{U_REVIEW_TOPIC}" >
                ...
                <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
                    ...
                    <tr> 
                        <td colspan="2"><span class="postbody">{postrow.ATTACHMENTS}</span></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr> 
            <td colspan="2" height="1" class="spaceRow"><img src="themes/NukeGold/forums/images/spacer.gif" alt="" width="1" height="1" /></td>
        </tr>
        <!-- END postrow -->
    </table>
            <!-- BEGIN switch_inline_mode -->
