        ...
        <tr>
            <td>
                <table style="background-color: #FFFFFF; border-color: #006699; border-style: solid; border-width: 1px;" width="100%" cellpadding="4" cellspacing="1" border="0">
                    <tr> 
                        <th style="background-color: #006699; background-image: url(themes/NukeGold/forums/images/cellpic3.gif); color: #FFA34F; font-size: 11px; font-weight: bold; height: 25px;">{L_SEARCH_USERNAME}</th>
                    </tr>
                    <tr> 
