...
define("_ACCTMODIFY","Modify User Account");
...
define("_ACTMSG","Your account has been created and logged in. Click <a href='modules.php?name=Your_Account'>this link</a> to go to your home page.");
...
define("_NOHOMECONFIG","Your Account Home Configuration has been disabled");
...
define("_ASREG3","Participate in our Surveys");
define("_ASREG4","Select how many news you want in the Home");
define("_ASREG5","Suggest new Web Links");
...
define("_EMAILREGISTERED","ERROR: Please enter your email address!");
define("_EMAILVALIDATE","Validate Email Changes:");
define("_ENCYCLOPEDIA","Encyclopedia");
define("_ERROREMAILSPACES","ERROR: Email address should not contain spaces!");
define("_ERRORHL","ERROR: There was a problem with this feed!");
define("_ERRORINVEMAIL","ERROR: Email address is invalid!");
define("_ERRORINVNICK","ERROR: Nickname is invalid!");
...
define("_LAST10JOURNAL","Last 10 Journal Entries");
define("_LAST10WEBLINK","Last 10 Web Links");
define("_LAST10WEBLINKS","Last 10 Web Links by");
define("_LAST4BBPIC","Last 4 Uploaded Pics");
define("_LIST","List");
...
define("_MEMDEL","<font color=red>Member Deactivated</font>");
...
define("_NAMERESERVED","ERROR: This Nickname is reserved!");
define("_NAMERESTRICTED","ERROR: Your selected Nickname contains a restricted string!");
...
define("_NOPROBLEM","Type your Nickname <i><b>or</b></i> Email address and click on Send Password. An automatic Email will be sent with your Confirmation Code. Re-type your Nickname, type your Confirmation Code and we will send a new password.");
...
define("_CHOOSETHEME", "Choose custom Theme");
define("_SHOWDOWNLOAD", "Access files from Downloads");
...
define("_RESENTMAIL2","An activation email has been resent to");
...
define("_NOSEARCHUSERS","No Users met your search criteria");
define("_SECCODEINCOR","ERROR: Wrong security code entered!");
...
define("_USERAPPINFO","User Application/Personal Information");
define("_USERCHECKDATA1","Congratulations");
define("_USERCHECKDATA2","you have successfully entered in all");
define("_USERCHECKDATA3","of the information required to setup your account!");
define("_USERCHECKDATA4","To complete your membership application, click Finish.");
define("_USERCHECKDATA5","The site Administrator will review your application and");
define("_USERCHECKDATA6","send you an activation link if you are approved.");
...
define("_YA_MUSTSUPPLY","You must supply your username or your email address!");
...
define("_YOUAREPENDING1","Welcome! Your application as a new member is pending. The site");
define("_YOUAREPENDING2","administrator will contact you when your application is processed.");
define("_YOUAREREGISTERED1","Request for a new account has been processed.");
define("_YOUAREREGISTERED2","You'll receive an email in the next few seconds with");
define("_YOUAREREGISTERED3","an activation link that should be visited in the next");
define("_YOUAREREGISTERED4","24 hours to be able to activate your account.");
...
define("_COOKIEPATHNOTE2","Keep empty to use automatic path");
...
define("_COOKIEINACTIVITY","Period of pageview inactivity:");
...
define("_YA_COOKIENO","Cookie functions seem to be disabled. Please change your browser settings!");
define("_YA_COOKIEYES","Your browser passed our cookie test without any problems!");

define("_YA_DELCOOKIEINFO1","If you have problems with logging in as a member, it is possible that your cookies have become corrupt. You may safely delete all cookies that are set by this website.");
define("_YA_COOKIEINFO","User Login/Cookie Information");
define("_YA_COOKIENAME","Cookie Name");
define("_YA_COOKIEVAL","Cookie Value");
define("_YA_COOKIESTAT","Cookie Status");
define("_YA_COOKIEDEL1","All cookies that are set by this website have been deleted. Once you log in again, new cookies will be set automatically.");
define("_YA_COOKIEDEL2","deleted");
define("_YA_COOKIEDELALL","Delete Cookies");
define("_YA_COOKIESHOWALL","Show Cookies");
define("_LOGIN","Login");
...
define("_YACOPPA3","Are you age <strong>13</strong> or above? <small>Please answer yes or no and click continue.</small>");
define("_YACOPPA4","We're Sorry! You must be <strong>13</strong> or have parents");
define("_YACOPPA5","send a signed letter of consent to our site admin.");
define("_YACOPPA6","Please contact our site admin for details by clicking <a href=\"./modules.php?name=Feedback\">here</a>.");
define("_YACOPPAFAX","Sorry no faxes accepted.");

/* YA TOS HACK */
define("_ACTIVATETOS","Show Terms of Service:");
define("_YATOS1","Terms of Service");
define("_YATOS3","I have read and agree to abide by these Terms.");
define("_YATOS4","New members need to agree to our Terms of Service!");
define("_EDITTOS", "Edit Terms of Service");
define("_EDITTOS2", "<small>Here you can edit the contents of your Terms of Service. <br />NOTE: This will only be displayed if you have activated Terms of Service.</small>");
define("_EDITTOS3","Terms of Service Body");
...
define("_YATOS5","All members need to accept these Terms of Service!");
define("_ACTIVATETOSNOTE","Force new members to agree when they register");
define("_ACTIVATETOSALL","Show Terms of Service to members:");
define("_ACTIVATETOSALLNOTE","If Terms of Service are new or changed");
define("_YATOSINTRO1","Hello! Our Terms of Service have been changed! To continue your membership we enquire you to agree with our Terms of Service (TOS). If you choose not to agree your account will not expire but you will not be able to login until you do.");
define("_YATOSINTRO2","Hello! Welcome as a new member of this website! To apply for a membership you will have to agree with our Terms of Service.");
...
define("_YA_NOREALNAME","ERROR: Please enter your name!");
