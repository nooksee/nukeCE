...
if ( $mode == 'newpm' )
{
        ...
        include(NUKE_FORUMS_DIR.'includes/page_header_review.php');
        ...
        include(NUKE_FORUMS_DIR.'includes/page_tail_review.php');
        exit;
...
/*****[BEGIN]******************************************
 [ Mod:    Attachment Mod                      v2.4.1 ]
 ******************************************************/
       $attachment['pm']->duplicate_attachment_pm($privmsg['privmsgs_attachment'], $privmsg['privmsgs_id'], $privmsg_sent_id);
/*****[END]********************************************
 [ Mod:    Attachment Mod                      v2.4.1 ]
 ******************************************************/
...
[ Mod:     Album                             v2.0.56 ]
******************************************************/
        $temp_url = append_sid('album_personal.' . $phpEx . '?user_id=' . $user_id_from);
        $album_img = '<a href="' . $temp_url . '"><img src="' . $images['icon_album'] . '" alt="' . sprintf($lang['Personal_Gallery_Of_User'], $privmsg['username_1']) . '" title="' . sprintf($lang['Personal_Gallery_Of_User'], $privmsg['username_1']) . '" border="0" /></a>';
        $album = '<a href="' . $temp_url . '">' . sprintf($lang['Personal_Gallery_Of_User'], $privmsg['username_1']) . '</a>';
/*****[END]********************************************
[ Mod:     Album                             v2.0.56 ]
******************************************************/					
        ...
        if ( !empty($privmsg['user_icq']) )
        {
                ...
                $icq_img = '<a href="icq:message?uin=' . $privmsg['user_icq'] . '"><img src="' . $images['icon_icq'] . '" alt="' . $lang['ICQ'] . '" title="' . $lang['ICQ'] . '" border="0" /></a>';
                $icq =  '<a href="icq:message?uin=' . $privmsg['user_icq'] . '">' . $lang['ICQ'] . '</a>';
        }
        else
        {
                $icq_status_img = '';
        ...
        $yim_img = ( $privmsg['user_yim'] ) ? '<a href="ymsgr:sendIM?' . $privmsg['user_yim'] . '&amp;.src=pg"><img src="' . $images['icon_yim'] . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
        $yim = ( $privmsg['user_yim'] ) ? '<a href="ymsgr:sendIM?' . $privmsg['user_yim'] . '&amp;.src=pg">' . $lang['YIM'] . '</a>' : '';
 ...
 ******************************************************/
        include(NUKE_FORUMS_DIR.'includes/ropm_quick_reply.php');
/*****[END]********************************************
 [ Mod:    PM Quick Reply                      v1.3.5 ]
 ******************************************************/
...
/*****[BEGIN]******************************************
 [ Mod:    Attachment Mod                      v2.4.1 ]
 ******************************************************/
                $attachment['pm']->delete_all_pm_attachments($mark_list);
/*****[END]********************************************
 [ Mod:    Attachment Mod                      v2.4.1 ]
 ******************************************************/
...
/*****[BEGIN]******************************************
 [ Mod:     Custom mass PM                     v1.4.7 ]
 ******************************************************/
                include(NUKE_FORUMS_DIR.'includes/emailer.'.$phpEx);
...
/*****[BEGIN]******************************************
 [ Mod:    Attachment Mod                      v2.4.1 ]
 ******************************************************/
                $attachment['pm']->insert_attachment_pm($privmsg_id);
/*****[END]********************************************
 [ Mod:    Attachment Mod                      v2.4.1 ]
 ******************************************************/
...
/*****[BEGIN]******************************************
 [ Mod:    Attachment Mod                      v2.4.1 ]
 ******************************************************/
                $attachment['pm']->preview_attachments();
/*****[END]********************************************
 [ Mod:    Attachment Mod                      v2.4.1 ]
 ******************************************************/
