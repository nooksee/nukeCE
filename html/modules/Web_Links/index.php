...
function menu($mainlink) {
    ...
    ."<tr><td><span class=\"content\"><input type=\"text\" size=\"25\" name=\"query\"> <input type=\"submit\" value=\""._SEARCH."\"></span></td></tr>"
    ."</table>"
    ."</form>";
...
function AddLink() {
    global $prefix, $db, $user, $cookie, $links_anonaddlinklock, $module_name;
    include_once(NUKE_BASE_DIR.'header.php');
    $mainlink = 1;
    menu(1);
    echo "<br />";
    ...
    if (is_user() || $links_anonaddlinklock == 1) {  /* 06-24-01 Bug fix : changed $links_anonaddlinklock != 1 to $links_anonaddlinklock == 1 */
        ...
        echo "</select><br /><br />"
            ...
            .""._YOURNAME.": <input type=\"text\" name=\"auth_name\" size=\"30\" maxlength=\"60\" value='".$usrinfo['username']."'><br />"
            .""._YOUREMAIL.": <input type=\"text\" name=\"email\" size=\"30\" maxlength=\"60\" value='".$usrinfo['user_email']."'><br /><br />"
            ."<table>".security_code(array(7), 'normal', 1)."</table>"
