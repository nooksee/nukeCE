...
$links_anonaddlinklock = 0;          //Lock Unregistered users from Suggesting New Links? (0=Yes 1=No)
...
$featurebox = 0;                     //1 to Show Feature Link Box on links Main Page? (1=Yes 0=No)
