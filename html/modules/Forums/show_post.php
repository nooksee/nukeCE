 ...
 ******************************************************/
        ...
        if ( $poster_id != ANONYMOUS )
        {
            ...
            $msn_img = ( $row['user_msnm'] ) ? '<a href="mailto: '. $row['user_msnm'] .'"><img src="' . $images['icon_msnm'] . '" alt="' . $lang['MSNM'] . '" title="' . $lang['MSNM'] . '" border="0" /></a>' : '';
            $msn = ( $row['user_msnm'] ) ? '<a href="mailto: '. $row['user_msnm'] .'">' . $lang['MSNM'] . '</a>' : '';
