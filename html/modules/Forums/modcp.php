...
include(NUKE_FORUMS_DIR.'includes/bbcode.'.$phpEx);
include(NUKE_FORUMS_DIR.'includes/functions_admin.'.$phpEx);

/*****[BEGIN]******************************************
 [ Mod:     Log Moderator Actions              v1.1.6 ]
 ******************************************************/
include(NUKE_FORUMS_DIR.'includes/functions_log.'.$phpEx);
/*****[END]********************************************
 [ Mod:     Log Moderator Actions              v1.1.6 ]
 ******************************************************/
...
switch( $mode )
{
        case 'delete':
                ...
                if ( $confirm )
                {
                        ...
                        include(NUKE_FORUMS_DIR.'includes/functions_search.'.$phpEx);
