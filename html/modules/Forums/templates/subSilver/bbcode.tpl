...
<table width="90%" cellspacing="1" cellpadding="3" border="0" align="center" class="bodyline">
    <tr> 
        <td class="helpline">
            <span class="genmed"><strong>{L_QUOTE}:</strong>
                <script type="text/javascript" src="{U_SXBB_JSLIB}"></script>
                <script type="text/javascript">
                    var id = 'SXBB' + (1000 + Math.floor(Math.random() * 5000));
                    SXBB[id] = new _SXBB(id);
...
<table class="bodyline" width="90%" cellspacing="1" cellpadding="3" border="0" align="center">
    <tr> 
        <td class="helpline">
            <span class="genmed"><strong>{USERNAME} {L_WROTE} ({U_VIEW_POST}):</strong>
                <script type="text/javascript" src="{U_SXBB_JSLIB}"></script>
                <script type="text/javascript">
                    var id = 'SXBB' + (1000 + Math.floor(Math.random() * 5000));
                    SXBB[id] = new _SXBB(id);
...
<table class="bodyline" width="90%" cellspacing="1" cellpadding="3" border="0" align="center">
    <tr> 
        <td class="helpline">
            <span class="genmed"><strong>{L_QUOTE} ({U_VIEW_POST}):</strong>
                <script type="text/javascript" src="{U_SXBB_JSLIB}"></script>
                <script type="text/javascript">
                    var id = 'SXBB' + (1000 + Math.floor(Math.random() * 5000));
                    SXBB[id] = new _SXBB(id);
...
<table width="90%" cellspacing="1" cellpadding="3" border="0" align="center" class="bodyline">
    <tr> 
        <td class="helpline">
            <span class="genmed"><strong>{L_CODE}:</strong>
                <script type="text/javascript" src="{U_SXBB_JSLIB}"></script>
                <script type="text/javascript">
                    var id = 'SXBB' + (1000 + Math.floor(Math.random() * 5000));
                    SXBB[id] = new _SXBB(id);
...
<table class="bodyline" border="0" align="center" width="90%" cellpadding="3" cellspacing="1">
    <tr> 
        <td class="helpline">
            <span class="genmed"><strong>{L_PHP}:</strong>
                <script type="text/javascript" src="{U_SXBB_JSLIB}"></script>
                <script type="text/javascript">
                    var id = 'SXBB' + (1000 + Math.floor(Math.random() * 5000));
                    SXBB[id] = new _SXBB(id);
...
<!-- BEGIN img --><img class="resize" src="{URL}" border="0" alt="" /><!-- END img -->
