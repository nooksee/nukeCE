...
<form action="{S_ALBUM_ACTION}" method="post">
    ...
    <tr>
        <!-- BEGIN piccol -->
        <td align="center" width="{S_COL_WIDTH}" class="row1" onMouseOver="this.className='row2';" onMouseOut="this.className='row1';"  onclick="window.location.href='{picrow.piccol.U_PIC}'"><span class="genmed"><a href="{picrow.piccol.U_PIC}" {TARGET_BLANK}><img src="{picrow.piccol.THUMBNAIL}" border="0" alt="{picrow.piccol.DESC}" title="{picrow.piccol.DESC}" vspace="10" /></a><br />{picrow.piccol.APPROVAL}</span></td>
        <!-- END piccol -->
        <!-- BEGIN nopiccol --> 
    ...
    <tr>
        <!-- BEGIN pic_detail -->
        <td class="row2" align="left" nowrap="nowrap"><span class="gensmall">{picrow.pic_detail.TIME}<br />{L_POSTER}: {picrow.pic_detail.POSTER}<br />{L_PIC_TITLE}: {picrow.pic_detail.TITLE}<br /></span></td>
        <!-- END pic_detail -->
        <!-- BEGIN picnodetail --> 
        <td class="row2">&nbsp;</td> 
        <!-- END picnodetail -->
