...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0">
    <tr align="right">
        <td class="catHead" colspan="2" height="28"><span class="nav"><a href="{U_PREVIOUS}" class="nav">{L_PREVIOUS_PIC}</a> :: <a href="{U_NEXT}" class="nav">{L_NEXT_PIC}</a> &nbsp;</span></td>
    </tr>
    <tr>
        <th class="thTop" height="25">{PIC_TITLE}</th>
    </tr>
    <tr>
        <td class="row1" align="center"><img class="resize" src="{U_PIC}" border="0" vspace="10" alt="{PIC_TITLE}" title="{PIC_TITLE}" /></td>
    </tr>
    <tr>
        <td class="row2">
            <table width="90%" align="center" border="0" cellpadding="3" cellspacing="2">
                ...
                <!-- BEGIN rate_switch -->
                <tr>
                    <td valign="top" align="right"><span class="genmed"><a href="{U_RATE}" class="genmed">{L_RATING}</a>:</span></td>
                    <td><b><span class="genmed">{PIC_RATING}</span></b></td>
                </tr>
                <!-- END rate_switch -->
                <!-- BEGIN comment_switch -->
                <tr>
                    <td align="right"><span class="genmed"><a href="{U_COMMENT}" class="genmed">{L_COMMENTS}</a>:</span></td>
