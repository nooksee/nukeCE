...
<!-- BEGIN attach -->
    ...
    <table width="95%" border="0" cellpadding="2" cellspacing="0" class="forumline" align="center">
    <tr>
        <th width="100%" class="thHead" align="center"><span class="gen">{postrow.attach.denyrow.L_DENIED}</span></th>
    </tr>
    </table>
    <div align="center"><hr width="95%" /></div>
    <!-- END denyrow -->
    ...
    <table width="95%" border="0" cellpadding="2" cellspacing="0" class="forumline" align="center">
    <tr>
        <th width="100%" colspan="2" class="thHead" align="center"><span class="gen">{postrow.attach.cat_stream.DOWNLOAD_NAME}</span></th>
    </tr>
    <tr>
        <td width="15%" class="row1"><span class="genmed">&nbsp;{L_DESCRIPTION}:</span></td>
        <td width="75%" class="row2">
    ...
    <tr>
        ...
        <td width="75%" class="row2"><span class="genmed">&nbsp;{postrow.attach.cat_stream.FILESIZE} {postrow.attach.cat_stream.SIZE_VAR}</td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="row3" colspan="2" align="center"><br />
    ...
    <table width="95%" border="0" cellpadding="2" cellspacing="0" class="forumline" align="center">
    <tr>
        <th width="100%" colspan="2" class="thHead" align="center"><span class="gen">{postrow.attach.cat_swf.DOWNLOAD_NAME}</span></th>
    </tr>
    <tr>
        <td width="15%" class="row1"><span class="genmed">&nbsp;{L_DESCRIPTION}:</span></td>
        <td width="75%" class="row2">
    ...
    <tr>
        <td width="15%" class="row1"><span class="genmed">&nbsp;{L_FILESIZE}:</span></td>
        <td width="75%" class="row2"><span class="genmed">&nbsp;{postrow.attach.cat_swf.FILESIZE} {postrow.attach.cat_swf.SIZE_VAR}</td>
    </tr>
    <tr>
    ...
    <table width="95%" border="0" cellpadding="2" cellspacing="0" class="forumline" align="center">
    <tr>
        <th width="100%" colspan="2" class="thHead" align="center"><span class="gen">{postrow.attach.cat_images.DOWNLOAD_NAME}</span></th>
    </tr>
    <tr>
        <td width="15%" class="row1"><span class="genmed">&nbsp;{L_DESCRIPTION}:</span></td>
        <td width="75%" class="row2">
    ...
    <tr>
        <td width="15%" class="row1"><span class="genmed">&nbsp;{L_FILESIZE}:</span></td>
        <td width="75%" class="row2"><span class="genmed">&nbsp;{postrow.attach.cat_images.FILESIZE} {postrow.attach.cat_images.SIZE_VAR}</td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="row3" colspan="2" align="center"><br /><img resizemod="on" onload="rmw_img_loaded(this)" src="{postrow.attach.cat_images.IMG_SRC}" alt="{postrow.attach.cat_images.DOWNLOAD_NAME}" border="0" /><br /><br /></td>
    </tr>
    </table>
    <div align="center"><hr width="95%" /></div>
    <!-- END cat_images -->
    ...
    <table width="95%" border="0" cellpadding="2" cellspacing="0" class="forumline" align="center">
    <tr>
        <th width="100%" colspan="2" class="thHead" align="center"><span class="gen">{postrow.attach.cat_thumb_images.DOWNLOAD_NAME}</span></th>
    </tr>
    <tr>
        <td width="15%" class="row1"><span class="genmed">&nbsp;{L_DESCRIPTION}:</span></td>
        <td width="75%" class="row2">
    ...
    <tr>
        <td width="15%" class="row1"><span class="genmed">&nbsp;{L_FILESIZE}:</span></td>
        <td width="75%" class="row2"><span class="genmed">&nbsp;{postrow.attach.cat_thumb_images.FILESIZE} {postrow.attach.cat_thumb_images.SIZE_VAR}</td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="row3" colspan="2" align="center"><br /><a href="{postrow.attach.cat_thumb_images.IMG_SRC}" target="_blank"><img src="{postrow.attach.cat_thumb_images.IMG_THUMB_SRC}" alt="{postrow.attach.cat_thumb_images.DOWNLOAD_NAME}" border="0" /></a><br /><br /></td>
    </tr>
    </table>
    <div align="center"><hr width="95%" /></div>
    ...
    <table width="95%" border="0" cellpadding="2" cellspacing="0" class="forumline" align="center">
    <tr>
        <th width="100%" colspan="3" class="thHead" align="center"><span class="gen">{postrow.attach.attachrow.DOWNLOAD_NAME}</span></th>
    </tr>
    <tr>
        <td width="15%" class="row1"><span class="genmed">&nbsp;{L_DESCRIPTION}:</span></td>
        <td width="75%" class="row2">
        ...
        <td rowspan="4" align="center" width="10%" class="row3">{postrow.attach.attachrow.S_UPLOAD_IMAGE}<br /><a href="{postrow.attach.attachrow.U_DOWNLOAD_LINK}" {postrow.attach.attachrow.TARGET_BLANK} class="genmed"><strong>{L_DOWNLOAD}</strong></a></td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="15%" class="row1"><span class="genmed">&nbsp;{L_FILESIZE}:</span></td>
        <td width="75%" class="row2"><span class="genmed">&nbsp;{postrow.attach.attachrow.FILESIZE} {postrow.attach.attachrow.SIZE_VAR}</td>
    </tr>
    <tr>
