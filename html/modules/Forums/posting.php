 ...
 ******************************************************/
include(NUKE_FORUMS_DIR.'includes/functions_log.php');
/*****[END]********************************************
 [ Mod:     Log Moderator Actions              v1.1.6 ]
 ******************************************************/
...
if ( $mode == 'topicreview' )
{
        require(NUKE_FORUMS_DIR.'includes/topic_review.'.$phpEx);
...
/*****[BEGIN]******************************************
 [ Mod:    Attachment Mod                      v2.4.1 ]
 ******************************************************/
                $attachment['posting']->insert_attachment($post_id);
/*****[END]********************************************
 [ Mod:    Attachment Mod                      v2.4.1 ]
 ******************************************************/
...
/*****[BEGIN]******************************************
 [ Mod:    Attachment Mod                      v2.4.1 ]
 ******************************************************/
                $attachment['posting']->preview_attachments();
/*****[END]********************************************
 [ Mod:    Attachment Mod                      v2.4.1 ]
 ******************************************************/
