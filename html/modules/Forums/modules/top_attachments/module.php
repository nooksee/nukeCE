...
$attachment_installed = ( isset($attach_config) ) ? TRUE : FALSE;
$attachment_version = ($attachment_installed) ? ATTACH_VERSION : '';
...
{
    message_die(GENERAL_MESSAGE, "Attachment has to be installed in order to see the Top Downloaded Attachments.");
}

if ( (!strstr($attachment_version, '2.4.')) )
{
    message_die(GENERAL_MESSAGE, 'Wrong Attachment Version detected.<br />Please update your Attachment (V' . $attachment_version . ') to at least Version 2.3.0.');
}
