...
function attach_faq_include($lang_file)
{
    ...
    {
        $language = attach_get_lang('lang_faq_attach');
        include($phpbb_root_path . 'language/lang_' . $language . '/lang_faq_attach.'.$phpEx);
    }
}

/**
* Setup Basic Authentication (NUKE_FORUMS_DIR.'includes/auth.php')
*/
...
/**
* Setup Viewtopic Authentication for f_access (viewtopic.php:NUKE_FORUMS_DIR.'includes/topic_review.php')
*/
...
* Groups are able to be grabbed, but it's not used within Attachment. ;)
* (NUKE_FORUMS_DIR.'includes/usercp_viewprofile.php')
*/
...
/**
* Prune Attachments (NUKE_FORUMS_DIR.'includes/prune.php')
*/
...
* not included in vanilla attachment
*
