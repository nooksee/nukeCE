...
include($phpbb_root_path . 'stats/content/bars.' . $phpEx);
include($phpbb_root_path . 'stats/content/statistical.' . $phpEx);
include($phpbb_root_path . 'stats/content/values.' . $phpEx);

// db cache
include($phpbb_root_path . 'stats/db_cache.' . $phpEx);
include($phpbb_root_path . 'stats/functions.' . $phpEx);
