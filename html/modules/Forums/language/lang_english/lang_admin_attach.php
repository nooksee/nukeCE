...
//
// Attachment Admin Language Variables
//
...
$lang['Manage_attachments_explain'] = 'Here you can configure the Main Settings for Attachment. If you press the Test Settings Button, Attachment does a few System Tests to be sure that the Mod will work properly. If you have problems with uploading Files, please run this Test, to get a detailed error-message.';
...
$lang['Disable_mod'] = 'Disable Attachment';
...
$lang['Use_gd2_explain'] = 'PHP is able to be compiled with the GD1 or GD2 Extension for image manipulating. To correctly create Thumbnails without imagemagick Attachment uses two different methods, based on your selection here. If your thumbnails are in a bad quality or screwed up, try to change this setting.';
$lang['Attachment_version'] = 'Attachment Version %s'; // %s is the version number
