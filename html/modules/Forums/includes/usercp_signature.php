...
include(NUKE_FORUMS_DIR.'includes/functions_post.'.$phpEx);
...
[ Mod:     Album                             v2.0.56 ]
******************************************************/
        'ALBUM_IMG'  => '<img src="' . $images['icon_album'] . '" alt="' . $lang['Personal_Gallery'] . '" title="' . $lang['Personal_Gallery'] . '" border="0" />',
/*****[END]********************************************
[ Mod:     Album                             v2.0.56 ]
******************************************************/					
