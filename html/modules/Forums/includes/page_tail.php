...
$admin_link = ( $userdata['user_level'] == ADMIN ) ? '<a href="modules/Forums/admin/index.php">' . $lang['Admin_panel'] . '</a>' : '';

/*****[BEGIN]******************************************
 [ Mod:     Report Posts                       v1.2.3 ]
 ******************************************************/
include_once(NUKE_FORUMS_DIR.'includes/functions_report.'.$phpEx);
...
if ( $userdata['user_level'] >= ADMIN )
{
    ...
    else 
    {
        ...
        $open_reports = '<b>' . $open_reports . '</strong>';
    }
