                         ...
                         <tr>
                             <td>
                                 <p align="left" dir="ltr">
                                     <span class="gen">
                                         <span class="genmed">
                                             <img alt="bold" title="[b]bold[/b]" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'b\')" onclick="BBCcode(\''.$form.'\',\''.$field.'\',this)" name="b" src="modules/Forums/images/bbcode/bold.gif" border="0" />
                                             <img alt="italic" title="[i]italic[/i]" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'i\')" onclick="BBCcode(\''.$form.'\',\''.$field.'\',this)" name="i" src="modules/Forums/images/bbcode/italic.gif" border="0" />
                                             <img alt="underline" title="[u]underline[/u]" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'u\')" onclick="BBCcode(\''.$form.'\',\''.$field.'\',this)" name="u" src="modules/Forums/images/bbcode/under.gif" border="0" />
                                             <img alt="Left to Right" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'ltr\')" onclick="BBCdir(\''.$form.'\',\''.$field.'\',\'ltr\')" name="dirltr" src="modules/Forums/images/bbcode/ltr.gif" border="0" />
                                             <img alt="Right to Left" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'rtl\')" onclick="BBCdir(\''.$form.'\',\''.$field.'\',\'rtl\')" name="dirrtl" src="modules/Forums/images/bbcode/rtl.gif" border="0" />
                                             <img alt="URL" title="[url]...[/url]" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'url\')" onclick="BBCurl(\''.$form.'\',\''.$field.'\')" name="url" src="modules/Forums/images/bbcode/url.gif" border="0" />
                                             <img alt="Email" title="[email]...[/email]" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'mail\')" onclick="BBCwmi(\''.$form.'\',\''.$field.'\',\'email\')" name="email" src="modules/Forums/images/bbcode/email.gif" border="0" />
                    ';
        if ($allowed) {
            $content .= '
                         <img alt="justify" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'justify\')" onclick="BBCode(\''.$form.'\',\''.$field.'\',\'align\',this)" name="justify" src="modules/Forums/images/bbcode/justify.gif" border="0" />
                         <img alt="left" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'left\')" onclick="BBCode(\''.$form.'\',\''.$field.'\',\'align\',this)" name="left" src="modules/Forums/images/bbcode/left.gif" border="0" />
                         <img alt="center" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'center\')" onclick="BBCode(\''.$form.'\',\''.$field.'\',\'align\',this)" name="center" src="modules/Forums/images/bbcode/center.gif" border="0" />
                         <img alt="right" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'right\')" onclick="BBCode(\''.$form.'\',\''.$field.'\',\'align\',this)" name="right" src="modules/Forums/images/bbcode/right.gif" border="0" />
                        ';
        }
        $content .= '
                     &nbsp;&nbsp;
                         ...
                         <tr>
                             <td dir="rtl">
                                 <p style="margin-top: 0pt; margin-bottom: 0pt;" dir="ltr" align="left">
                                     <span class="gen">
                                         <span class="genmed">
                                             <img alt="Image" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'img\')" onclick="BBCwmi(\''.$form.'\',\''.$field.'\',\'img\')" name="img" src="modules/Forums/images/bbcode/img.gif" border="0" />
                                             <img alt="Flash" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'flash\')" onclick="BBCmm(\''.$form.'\',\''.$field.'\',\'flash\')" name="flash" src="modules/Forums/images/bbcode/flash.gif" border="0" />
                                             <img alt="Video" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'video\')" onclick="BBCmm(\''.$form.'\',\''.$field.'\',\'video\')" name="video" src="modules/Forums/images/bbcode/video.gif" border="0" />
                                             <img alt="Quote" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'quote\')" onclick="BBCcode(\''.$form.'\',\''.$field.'\',this)" name="quote" src="modules/Forums/images/bbcode/quote.gif" border="0" />
                                             <img alt="Code" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'code\')" onclick="BBCcode(\''.$form.'\',\''.$field.'\',this)" name="code" src="modules/Forums/images/bbcode/code.gif" border="0" />
                                             <img alt="PHP" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'php\')" onclick="BBCcode(\''.$form.'\',\''.$field.'\',this)" name="php" src="modules/Forums/images/bbcode/php.gif" border="0" />
                                             <img alt="H-Line" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'hr\')" onclick="BBChr(\''.$form.'\',\''.$field.'\')" name="hr" src="modules/Forums/images/bbcode/hr.gif" border="0" />
                                             <img alt="Marque to down" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'marqd\')" onclick="BBCode(\''.$form.'\',\''.$field.'\',\'marq\',this)" name="down" src="modules/Forums/images/bbcode/marqd.gif" border="0" />
                                             <img alt="Marque to up" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'marqu\')" onclick="BBCode(\''.$form.'\',\''.$field.'\',\'marq\',this)" name="up" src="modules/Forums/images/bbcode/marqu.gif" border="0" />
                                             <img alt="Marque to left" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'marql\')" onclick="BBCode(\''.$form.'\',\''.$field.'\',\'marq\',this)" name="left" src="modules/Forums/images/bbcode/marql.gif" border="0" />
                                             <img alt="Marque to right" style="border-style: outset; border-width: 1px;" onmouseover="helpline(\''.$form.'\',\''.$field.'\',\'marqr\')" onclick="BBCode(\''.$form.'\',\''.$field.'\',\'marq\',this)" name="right" src="modules/Forums/images/bbcode/marqr.gif" border="0" />
                        ';
        }
        $content .= '
                                         </span>
