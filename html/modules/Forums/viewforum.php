 ...
 ******************************************************/
include(NUKE_FORUMS_DIR.'includes/functions_separate.'.$phpEx);
/*****[END]********************************************
 [ Mod:     Separate Announcements & Sticky   v2.0.0a ]
 ******************************************************/
...
if ( $is_auth['auth_mod'] && $board_config['prune_enable'] )
{
...

        {
                ...
                include(NUKE_FORUMS_DIR.'includes/prune.php');

                require(NUKE_FORUMS_DIR.'includes/functions_admin.php');
                auto_prune($forum_id);
        }
}
//
