...
function PreviewStory($name, $address, $subject, $story, $storyext, $topic, $alanguage, $posttype) {
    ...
    if (empty($story) && empty($storyext)) {
        DisplayErrorReturn(_ERROR_STORY);
    }
    if (empty($subject)) {
        DisplayErrorReturn(_ERROR_SUBJECT);
    }
...
/*****[BEGIN]******************************************
 [ Mod:     News BBCodes                    v1.0.0 ]
 ******************************************************/
    $story2 = BBCode2Html(stripslashes($story2));
/*****[END]********************************************
 [ Mod:     News BBCodes                    v1.0.0 ]
 ******************************************************/
    OpenTable();
 ...
 ******************************************************/
    ...
    if($notify) {
        ...
        nuke_mail($notify_email, $notify_subject, $notify_message, "From: $notify_from\nX-Mailer: PHP/" . phpversion());
    }
    include_once(NUKE_BASE_DIR.'header.php');
    OpenTable();
/*****[BEGIN]******************************************
