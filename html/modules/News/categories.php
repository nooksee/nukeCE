...
$categories = 1;
automated_news();
if ($catid == 0 OR empty($catid)) { redirect("modules.php?name=$module_name"); }
...
switch ($op) {
    ...
    case "newindex":
        if($neconfig["homenumber"] == 0) {
            if (isset($userinfo['setstorynum'])) { $storynum = $userinfo['setstorynum']; } else { $storynum = $storyhome; }
        } else {
 ...
 ******************************************************/
            ...
            $the_icons = "";
            if (is_user()) {
                $the_icons .= " | <a href='modules.php?name=$module_name&amp;file=print&amp;sid=".$artinfo["sid"]."' target='_blank'><img src='images/print.gif' border='0' alt='"._PRINTER."' title='"._PRINTER."' width='11' height='11'></a>&nbsp;<a href='modules.php?name=$module_name&amp;file=print_pdf&amp;sid=".$artinfo["sid"]."' rel='5' class='newWindow'><img src='images/pdf.gif' border='0' alt='"._PDF."' title='"._PDF."' width='11' height='11'></a>&nbsp;<a href='modules.php?name=$module_name&amp;file=friend&amp;op=FriendSend&amp;sid=".$artinfo["sid"]."'><img src='images/friend.gif' border='0' alt='"._FRIEND."' title='"._FRIEND."' width='11' height='11'></a>\n";
            }
