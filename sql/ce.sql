...
CREATE TABLE IF NOT EXISTS `nuke_security_agents` (
  ...
  `agent_url` varchar(60) DEFAULT NULL,
  `agent_ban` int(11) NOT NULL DEFAULT '0',
  `agent_desc` text,
...
('blogsearchbot', 'blogsearchbot', NULL, NULL, -1, 'Doesn''t follow robots.txt'),
...
('Diamond', 'DiamondBot', NULL, 'searchscout.com', -1, 'Claria (ex Gator) robot (64.152.73.xx, NULL), s. also Claria'),
...
('hl_ftien_spider', 'hl_ftien_spider', NULL, NULL, -1, 'Doesn''t follow robots.txt'),
('HMSE', 'HMSE_Robot', NULL, NULL, -1, 'Doesn''t follow robots.txt'),
...
('HTTrack', 'HTTrack', NULL, 'httrack.com', -1, 'Website copier'),
...
('iSiloX', 'iSiloX/', NULL, 'isilox.com', -1, 'Doesn''t follow robots.txt'),
...
('Mizzu', 'Mizzu Labs', NULL, NULL, -1, 'Some spam bot from Jasmine Internet - Bangkok\nDoesn''t follow robots.txt'),
...
('Nimble', 'NimbleCrawler', NULL, 'healthline.com', -1, 'Doesn''t follow robots.txt'),
('Ninja', 'Download Ninja', NULL, NULL, 0, NULL),
('Norbert', 'Norbert the Spider', NULL, 'burf.com', -1, 'Doesn''t follow robots.txt'),
...
('Poirot', 'Poirot', NULL, NULL, -1, 'ThePlanet/jaja-jak-globusy.com Google Adsense refferer spam bot\nDoesn''t follow robots.txt'),
...
('RSSOwl', 'RSSOwl/', NULL, 'rssowl.org', 0, NULL),
...
('Snap', 'snap.com', NULL, 'snap.com', -1, 'Doesn''t follow robots.txt'),
...
('Space Bison', 'Space Bison/', NULL, NULL, -1, 'Doesn''t follow robots.txt'),
('Spider', 'SpiderKU/', NULL, NULL, -1, 'Doesn''t follow robots.txt'),
('SpiderMan', 'SpiderMan', NULL, NULL, -1, 'Yahoo Search user agent or spider\nDoesn''t follow robots.txt'),
...
('Syntryx', 'Syntryx', NULL, 'syntryx.com', -1, 'Syntryx Solution Suite - domain / keyword crawler\nDoesn''t follow robots.txt'),
('T8Abot', 'T8Abot/', NULL, NULL, -1, 'Doesn''t follow robots.txt'),
...
('VRLImage', 'Vision Research Lab', NULL, '(beeld|vision).ece.ucsb.edu', -1, 'Image spider\nDoesn''t follow robots.txt'),
...
('webbot', 'webbot(', NULL, 'webbot.com/bot.htm', -1, 'Doesn''t follow robots.txt'),
...
('WebSauger', 'WebSauger', NULL, NULL, -1, 'Doesn''t follow robots.txt'),
('WebStripper', 'WebStripper/', NULL, NULL, 0, NULL),
('Wget', 'Wget/', NULL, NULL, 0, NULL),
('Wire', 'WIRE', NULL, NULL, 0, NULL),
('WWWeasel', 'WWWeasel', NULL, 'wwweasel.de', -1, 'Doesn''t follow robots.txt'),
('wwwster', 'wwwster/', NULL, NULL, -1, 'Doesn''t follow robots.txt'),
...
('Yeti', 'Yeti', NULL, NULL, -1, '1noon.com search Korea robot\nDoesn''t follow robots.txt'),
